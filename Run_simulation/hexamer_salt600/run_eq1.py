...
# set up simulation time. nsteps is the number of steps before changing temperature
tot_t=10000000
nsteps=100
dt=int(tot_t/nsteps)
# expand box along Z-axis to this distance (in nm). This sets up slab simulations
...
# Load system
system_xml = 'PopZ_FL_hexamer_system.xml'
...
# change box vectors to set up slab simulation
...
with open('PopZ_FL_hexamer.xml', 'w') as output:
...
# Run production by shifting temperature every nsteps toward the goal temperature
