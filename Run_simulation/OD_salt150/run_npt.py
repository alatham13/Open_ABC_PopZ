...
PopZ_parser = MOFFParser.from_atomistic_pdb('PopZ_OD_trimer_AF.pdb', 'PopZ_OD_trimer_CA.pdb')

# PopZ_OD_trimer: we want to model the complex by rigidizing H3-H4 as a complex, and keeping H2 as a flexible helix.
...
box_b=100
box_c=100
insert_molecules('PopZ_OD_trimer_CA.pdb', 'start.pdb', n_mol, box=[box_a, box_b, box_c])
...
# save final system
condensate.save_system('PopZ_OD_trimer_system.xml')
